...
//! ekrana basarken kod tekrarı oluşmaması 
//! için bir dizi tanımladık
const arr = [
    {
        icon : mile,
    ...
    <div className="border shadow rounded hover:shadow-lg">
       <div className="relative h-[250px]">
        ...
        <hr className="border-[#E9E9E9] border-2 mt-2 mb-4" />
            ...
            <Link href={`/car/${car._id}`} className="text-blue-500 text-2xl sm:text-xl flex items-center gap-2 hover:text-blue-800 transition">
                Detay
